...
class _DashboardState extends State<Dashboard> {
  ...
  void _sortClasses() {
    ...
    _classes.sort((a, b) {
      final aRank = priority[a.session] ?? 99;
      final bRank = priority[b.session] ?? 99;
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color:
                    session == 'Session Started' ? Color(0xFFDBFCE7) : session == 'Pending' ? Color(0x25FBD600) : Color(0x90DBEAFE),
                  ),
